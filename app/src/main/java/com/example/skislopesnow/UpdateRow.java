...
public class UpdateRow extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mySqliteOpenHelper.updateRow(resort, status, hours, snow, weather, halfday, fullday, sqLiteDatabase);


                Toast.makeText(getBaseContext(), "Row Updated",Toast.LENGTH_LONG).show();
    ...
    private void showToast(String text) {
        Toast.makeText(UpdateRow.this, text, Toast.LENGTH_SHORT).show();
    }
    public void goBack(){
