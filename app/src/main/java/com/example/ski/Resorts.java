...
public class Resorts {
    ...
    public Resorts(String resort, String loc, String status, String hours, String fullday, String halfday, String weather, String snow) {
        this.resort = resort;
        this.loc = loc;
        this.status = status;
        this.hours = hours;
    ...
    public Resorts(int id, String resort, String loc, String status, String hours, String fullday, String halfday, String weather, String snow) {
        this.id = id;
        this.resort = resort;
        this.loc = loc;
        this.status = status;
